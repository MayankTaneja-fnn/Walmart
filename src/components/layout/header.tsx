...
import { Menu, Search, ShoppingCart, User, Grid3X3, Heart } from 'lucide-react';
      ...
      <div className="container flex h-20 max-w-screen-2xl items-center justify-between gap-4">
        <Link href="/" className="flex items-center gap-2 mr-4">
          <Button
            variant="ghost"
            size="icon"
            className="w-12 h-12 bg-primary hover:bg-primary/90 text-primary-foreground hover:text-primary-foreground rounded-full"
          >
            <WalmartLogo className="h-6 w-6" />
          </Button>
          <span className="font-bold text-2xl hidden md:block text-primary font-headline">Walmart</span>
        </Link>
            ...
            <SheetContent side="left">
              <nav className="flex flex-col gap-6 text-lg font-medium mt-8">
                <Link href="/" className="flex items-center gap-2 text-lg font-semibold mb-4">
                  <WalmartLogo className="h-6 w-6 text-primary" />
                  <span className="font-bold font-headline">Walmart</span>
                </Link>
                {navLinks.map((link) => (
                  <Link
                    key={link.href}
        ...
        <div className="hidden md:flex flex-1 max-w-xl relative">
          ...
          <Input placeholder="Search everything at Walmart online..." className="pl-10 h-11" />
        ...
        <div className="flex items-center gap-2">
          ...
          {loading ? (
             <Button variant="ghost" className="hidden md:flex flex-col h-auto p-2 animate-pulse">
